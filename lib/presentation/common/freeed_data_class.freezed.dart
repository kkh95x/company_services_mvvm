...
part of 'freeed_data_class.dart';
...
abstract class $RegisterObjectCopyWith<$Res> {
  ...
  $Res call(
      {String username, String mobileNumber, String email, String password});
}
...
class _$_RegisterObject implements _RegisterObject {
  _$_RegisterObject(
      this.username, this.mobileNumber, this.email, this.password);
  ...
  @override
  String toString() {
    return 'RegisterObject(username: $username, mobileNumber: $mobileNumber, email: $email, password: $password)';
  }
...
abstract class _RegisterObject implements RegisterObject {
  factory _RegisterObject(final String username, final String mobileNumber,
      final String email, final String password) = _$_RegisterObject;
